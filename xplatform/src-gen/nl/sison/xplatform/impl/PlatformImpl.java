 ...
 *   <li>{@link nl.sison.xplatform.impl.PlatformImpl#getGenerateWhere <em>Generate Where</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlatformImpl extends MinimalEObjectImpl.Container implements Platform
{
  ...
  public EList<String> getGenerateWhere()
  {
    ...
    {
      generateWhere = new EDataTypeEList<String>(String.class, this, XplatformPackage.PLATFORM__GENERATE_WHERE);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XplatformPackage.PLATFORM__PLATFORMS:
        return getPlatforms();
      case XplatformPackage.PLATFORM__GENERATE_WHERE:
