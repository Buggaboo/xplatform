 ...
 * <ul>
 *   <li>{@link nl.sison.xplatform.impl.StringListImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringListImpl extends NestedTypeImpl implements StringList
{
  ...
  {
    return XplatformPackage.Literals.STRING_LIST;
  }
  ...
  public EList<String> getValues()
  {
    if (values == null)
    {
      values = new EDataTypeEList<String>(String.class, this, XplatformPackage.STRING_LIST__VALUES);
    }
    return values;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XplatformPackage.STRING_LIST__VALUES:
        return getValues();
    }
