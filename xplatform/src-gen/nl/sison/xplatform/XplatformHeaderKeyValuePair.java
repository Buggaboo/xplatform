 ...
 *   <li>{@link nl.sison.xplatform.XplatformHeaderKeyValuePair#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
...
public interface XplatformHeaderKeyValuePair extends EObject
{
   ...
   * @see #setValue(String)
   * @see nl.sison.xplatform.XplatformPackage#getXplatformHeaderKeyValuePair_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link nl.sison.xplatform.XplatformHeaderKeyValuePair#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
