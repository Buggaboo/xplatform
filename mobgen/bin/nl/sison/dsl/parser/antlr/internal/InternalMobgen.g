...
(
    ...
    |		lv_stringType_0_2=RULE_EMPTY_JSON_OBJECT
		{
    ...
    |		lv_stringType_0_3=RULE_EMPTY_JSON_ARRAY
		{
    ...
    |		lv_stringType_0_4=RULE_JSON_LITERAL_NULL
		{
    ...
    |		lv_stringType_0_5=RULE_JSON_NUMBER
		{
