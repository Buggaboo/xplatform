...
public class MobgenGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class JsonLiteralValueElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Assignment cStringTypeAssignment_0 = (Assignment)cAlternatives.eContents().get(0);
		private final Alternatives cStringTypeAlternatives_0_0 = (Alternatives)cStringTypeAssignment_0.eContents().get(0);
		private final RuleCall cStringTypeSTRINGTerminalRuleCall_0_0_0 = (RuleCall)cStringTypeAlternatives_0_0.eContents().get(0);
		private final RuleCall cStringTypeEMPTY_JSON_OBJECTTerminalRuleCall_0_0_1 = (RuleCall)cStringTypeAlternatives_0_0.eContents().get(1);
		private final RuleCall cStringTypeEMPTY_JSON_ARRAYTerminalRuleCall_0_0_2 = (RuleCall)cStringTypeAlternatives_0_0.eContents().get(2);
		private final RuleCall cStringTypeJSON_LITERAL_NULLTerminalRuleCall_0_0_3 = (RuleCall)cStringTypeAlternatives_0_0.eContents().get(3);
		private final RuleCall cStringTypeJSON_NUMBERTerminalRuleCall_0_0_4 = (RuleCall)cStringTypeAlternatives_0_0.eContents().get(4);
		private final Assignment cBooleanTypeAssignment_1 = (Assignment)cAlternatives.eContents().get(1);
		private final RuleCall cBooleanTypeJsonLiteralBooleanEnumRuleCall_1_0 = (RuleCall)cBooleanTypeAssignment_1.eContents().get(0);
		private final Assignment cMetaTypeAssignment_2 = (Assignment)cAlternatives.eContents().get(2);
		private final RuleCall cMetaTypeJsonMetaScalarTypeEnumRuleCall_2_0 = (RuleCall)cMetaTypeAssignment_2.eContents().get(0);
		
		//JsonLiteralValue:
		//	stringType=(STRING | EMPTY_JSON_OBJECT | EMPTY_JSON_ARRAY | JSON_LITERAL_NULL | JSON_NUMBER) |
		//	booleanType=JsonLiteralBoolean | metaType=JsonMetaScalarType;
		public ParserRule getRule() { return rule; }
		...
		//STRING | EMPTY_JSON_OBJECT | EMPTY_JSON_ARRAY | JSON_LITERAL_NULL | JSON_NUMBER
		public Alternatives getStringTypeAlternatives_0_0() { return cStringTypeAlternatives_0_0; }

		//STRING
		public RuleCall getStringTypeSTRINGTerminalRuleCall_0_0_0() { return cStringTypeSTRINGTerminalRuleCall_0_0_0; }

		//EMPTY_JSON_OBJECT
		public RuleCall getStringTypeEMPTY_JSON_OBJECTTerminalRuleCall_0_0_1() { return cStringTypeEMPTY_JSON_OBJECTTerminalRuleCall_0_0_1; }

		//EMPTY_JSON_ARRAY
		public RuleCall getStringTypeEMPTY_JSON_ARRAYTerminalRuleCall_0_0_2() { return cStringTypeEMPTY_JSON_ARRAYTerminalRuleCall_0_0_2; }

		//JSON_LITERAL_NULL
		public RuleCall getStringTypeJSON_LITERAL_NULLTerminalRuleCall_0_0_3() { return cStringTypeJSON_LITERAL_NULLTerminalRuleCall_0_0_3; }

		//JSON_NUMBER
		public RuleCall getStringTypeJSON_NUMBERTerminalRuleCall_0_0_4() { return cStringTypeJSON_NUMBERTerminalRuleCall_0_0_4; }

		//booleanType=JsonLiteralBoolean
		public Assignment getBooleanTypeAssignment_1() { return cBooleanTypeAssignment_1; }

		//JsonLiteralBoolean
		public RuleCall getBooleanTypeJsonLiteralBooleanEnumRuleCall_1_0() { return cBooleanTypeJsonLiteralBooleanEnumRuleCall_1_0; }

		//metaType=JsonMetaScalarType
		public Assignment getMetaTypeAssignment_2() { return cMetaTypeAssignment_2; }

		//JsonMetaScalarType
		public RuleCall getMetaTypeJsonMetaScalarTypeEnumRuleCall_2_0() { return cMetaTypeJsonMetaScalarTypeEnumRuleCall_2_0; }
	}
