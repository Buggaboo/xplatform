 ...
 * <ul>
 *   <li>{@link nl.sison.dsl.mobgen.MapInstance#getName <em>Name</em>}</li>
...
public interface MapInstance extends EObject
{
   ...
   * @see #setName(String)
   * @see nl.sison.dsl.mobgen.MobgenPackage#getMapInstance_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link nl.sison.dsl.mobgen.MapInstance#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
