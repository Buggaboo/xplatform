 ...
 * <ul>
 *   <li>{@link nl.sison.dsl.mobgen.impl.MobgenHeaderImpl#getName <em>Name</em>}</li>
 *   <li>{@link nl.sison.dsl.mobgen.impl.MobgenHeaderImpl#getHeaderKeyValues <em>Header Key Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MobgenHeaderImpl extends MinimalEObjectImpl.Container implements MobgenHeader
{
  ...
  {
    return MobgenPackage.Literals.MOBGEN_HEADER;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MobgenPackage.MOBGEN_HEADER__NAME, oldName, name));
  }
  ...
  public EList<MobgenHeaderKeyValuePair> getHeaderKeyValues()
  {
    ...
    {
      headerKeyValues = new EObjectContainmentEList<MobgenHeaderKeyValuePair>(MobgenHeaderKeyValuePair.class, this, MobgenPackage.MOBGEN_HEADER__HEADER_KEY_VALUES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MobgenPackage.MOBGEN_HEADER__HEADER_KEY_VALUES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MobgenPackage.MOBGEN_HEADER__NAME:
        return getName();
      case MobgenPackage.MOBGEN_HEADER__HEADER_KEY_VALUES:
