...
public class MobgenHeaderKeyValuePairImpl extends MinimalEObjectImpl.Container implements MobgenHeaderKeyValuePair
{
  ...
  {
    return MobgenPackage.Literals.MOBGEN_HEADER_KEY_VALUE_PAIR;
  }
  ...
  public void setKey(String newKey)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MobgenPackage.MOBGEN_HEADER_KEY_VALUE_PAIR__KEY, oldKey, key));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MobgenPackage.MOBGEN_HEADER_KEY_VALUE_PAIR__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MobgenPackage.MOBGEN_HEADER_KEY_VALUE_PAIR__KEY:
        return getKey();
