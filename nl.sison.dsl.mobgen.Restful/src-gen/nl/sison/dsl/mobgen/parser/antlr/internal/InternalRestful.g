...
entryRuleJsonLiteralValue returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getJsonLiteralValueRule()); }
	 iv_ruleJsonLiteralValue=ruleJsonLiteralValue 
	 { $current=$iv_ruleJsonLiteralValue.current; } 
	 EOF 
;

// Rule JsonLiteralValue
ruleJsonLiteralValue returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
    ...
    |(
(
		lv_emptyObject_1_0=RULE_EMPTY_JSON_OBJECT
		{
    ...
    |(
(
		lv_emptyArray_2_0=RULE_EMPTY_JSON_ARRAY
		{
    ...
    |(
(
		lv_literalNull_3_0=RULE_JSON_LITERAL_NULL
		{
    ...
    |(
(
		lv_numberFloat_4_0=RULE_JSON_NUMBER_FLOAT
		{
...
entryRuleJsonEnumType returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getJsonEnumTypeRule()); } 
	 iv_ruleJsonEnumType=ruleJsonEnumType 
	 { $current=$iv_ruleJsonEnumType.current.getText(); }  
	 EOF 
;

// Rule JsonEnumType
ruleJsonEnumType returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
// Rule RestfulMethods
ruleRestfulMethods returns [Enumerator current=null] 
    @init { enterRule(); }
    @after { leaveRule(); }:
((	enumLiteral_0='PUT' 
	{
...
ruleJsonMetaScalarType returns [Enumerator current=null] 
    @init { enterRule(); }
    @after { leaveRule(); }:
...
ruleJsonLiteralBoolean returns [Enumerator current=null] 
    @init { enterRule(); }
    @after { leaveRule(); }:
((	enumLiteral_0='true' 
	{
