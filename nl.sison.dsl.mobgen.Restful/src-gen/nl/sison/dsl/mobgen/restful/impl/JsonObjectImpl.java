 ...
 * <ul>
 *   <li>{@link nl.sison.dsl.mobgen.restful.impl.JsonObjectImpl#getKeyValuePair <em>Key Value Pair</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JsonObjectImpl extends MinimalEObjectImpl.Container implements JsonObject
{
  ...
  {
    return RestfulPackage.Literals.JSON_OBJECT;
  }
  ...
  public EList<JsonKeyValuePair> getKeyValuePair()
  {
    ...
    {
      keyValuePair = new EObjectContainmentEList<JsonKeyValuePair>(JsonKeyValuePair.class, this, RestfulPackage.JSON_OBJECT__KEY_VALUE_PAIR);
    }
    return keyValuePair;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RestfulPackage.JSON_OBJECT__KEY_VALUE_PAIR:
