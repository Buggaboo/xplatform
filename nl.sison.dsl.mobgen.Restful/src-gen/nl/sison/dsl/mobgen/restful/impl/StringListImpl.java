 ...
 * <ul>
 *   <li>{@link nl.sison.dsl.mobgen.restful.impl.StringListImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringListImpl extends MinimalEObjectImpl.Container implements StringList
{
  ...
  {
    return RestfulPackage.Literals.STRING_LIST;
  }
  ...
  public EList<String> getValues()
  {
    if (values == null)
    {
      values = new EDataTypeEList<String>(String.class, this, RestfulPackage.STRING_LIST__VALUES);
    }
    return values;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RestfulPackage.STRING_LIST__VALUES:
        return getValues();
    }
