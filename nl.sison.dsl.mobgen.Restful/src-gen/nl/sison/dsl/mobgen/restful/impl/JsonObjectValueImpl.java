 ...
 * <ul>
 *   <li>{@link nl.sison.dsl.mobgen.restful.impl.JsonObjectValueImpl#getScalar <em>Scalar</em>}</li>
 *   <li>{@link nl.sison.dsl.mobgen.restful.impl.JsonObjectValueImpl#getComposite <em>Composite</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JsonObjectValueImpl extends MinimalEObjectImpl.Container implements JsonObjectValue
{
  ...
  {
    return RestfulPackage.Literals.JSON_OBJECT_VALUE;
  }
  ...
  public NotificationChain basicSetScalar(JsonLiteralValue newScalar, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RestfulPackage.JSON_OBJECT_VALUE__SCALAR, oldScalar, newScalar);
  ...
  public void setScalar(JsonLiteralValue newScalar)
  {
    if (newScalar != scalar)
    {
      ...
      if (scalar != null)
        msgs = ((InternalEObject)scalar).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RestfulPackage.JSON_OBJECT_VALUE__SCALAR, null, msgs);
      if (newScalar != null)
        msgs = ((InternalEObject)newScalar).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RestfulPackage.JSON_OBJECT_VALUE__SCALAR, null, msgs);
      msgs = basicSetScalar(newScalar, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RestfulPackage.JSON_OBJECT_VALUE__SCALAR, newScalar, newScalar));
  }
  ...
  public NotificationChain basicSetComposite(JsonCompositeValue newComposite, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RestfulPackage.JSON_OBJECT_VALUE__COMPOSITE, oldComposite, newComposite);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setComposite(JsonCompositeValue newComposite)
  {
    if (newComposite != composite)
    {
      NotificationChain msgs = null;
      if (composite != null)
        msgs = ((InternalEObject)composite).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RestfulPackage.JSON_OBJECT_VALUE__COMPOSITE, null, msgs);
      if (newComposite != null)
        msgs = ((InternalEObject)newComposite).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RestfulPackage.JSON_OBJECT_VALUE__COMPOSITE, null, msgs);
      msgs = basicSetComposite(newComposite, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RestfulPackage.JSON_OBJECT_VALUE__COMPOSITE, newComposite, newComposite));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RestfulPackage.JSON_OBJECT_VALUE__SCALAR:
        return basicSetScalar(null, msgs);
      case RestfulPackage.JSON_OBJECT_VALUE__COMPOSITE:
