 ...
 * <ul>
 *   <li>{@link nl.sison.dsl.mobgen.restful.impl.JsonArrayImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JsonArrayImpl extends MinimalEObjectImpl.Container implements JsonArray
{
  ...
  {
    return RestfulPackage.Literals.JSON_ARRAY;
  }
  ...
  public EList<JsonObjectValue> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<JsonObjectValue>(JsonObjectValue.class, this, RestfulPackage.JSON_ARRAY__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RestfulPackage.JSON_ARRAY__ITEMS:
