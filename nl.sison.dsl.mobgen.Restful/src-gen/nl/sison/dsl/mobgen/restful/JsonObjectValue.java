 ...
 * <ul>
 *   <li>{@link nl.sison.dsl.mobgen.restful.JsonObjectValue#getScalar <em>Scalar</em>}</li>
 *   <li>{@link nl.sison.dsl.mobgen.restful.JsonObjectValue#getComposite <em>Composite</em>}</li>
 * </ul>
 * </p>
 *
 * @see nl.sison.dsl.mobgen.restful.RestfulPackage#getJsonObjectValue()
 * @model
 * @generated
 */
public interface JsonObjectValue extends EObject
{
   ...
   * @see nl.sison.dsl.mobgen.restful.RestfulPackage#getJsonObjectValue_Scalar()
  ...
  /**
   * Sets the value of the '{@link nl.sison.dsl.mobgen.restful.JsonObjectValue#getScalar <em>Scalar</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see nl.sison.dsl.mobgen.restful.RestfulPackage#getJsonObjectValue_Composite()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link nl.sison.dsl.mobgen.restful.JsonObjectValue#getComposite <em>Composite</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
