...
@Singleton
public class ResourceGrammarAccess extends AbstractGrammarElementFinder {
	...
	@Inject
	public ResourceGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("nl.sison.dsl.mobgen.Resource".equals(grammar.getName())) {
				return grammar;
			}
